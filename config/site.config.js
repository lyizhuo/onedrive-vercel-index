...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'chris@yioffice.tk',
  ...
  protectedRoutes: ['/🔒 Private', '/💽 项目'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:lyizhuo@outlook.com',
